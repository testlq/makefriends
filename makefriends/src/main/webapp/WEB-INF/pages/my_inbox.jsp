<%@page import="com.yc.biz.impl.UserBizImpl"%>
		    ...
		    <div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
			   ...
			   <div id="myTabContent" class="tab-content">
				  <div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
					...
					<h4>发表个人动态：</h4>
						<form action="addDynamic.action" method="post">
																																																																																		 <div class="jobs-item with-thumb">
																																																																																			 <div class="thumb_comment">
																																																																																					<div class="thumb_text"><textarea style="width:800px;height:100px;resize:none;" name="content"></textarea></div>
																																																																															...
																																																																															<c:forEach items="${myDynamic}" var="d">
	              <div class="jobs-item with-thumb">
	                  <div class="thumb_top">
					        <div class="thumb"><a href="view_profile.action"><img src="images/p13.jpg" class="img-responsive" alt=""/></a></div>
						    <div class="jobs_right">
								<h6 class="title"><a href="view_profile.action">${d.username} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2018-09-11</a></h6>
